...
export function AuthProvider({ children }) {
  ...
  const register=useCallback(async (username, email, password, role, walletAddress) => {
    const { data }=await api.post('/auth/register', { username, email, password, role, walletAddress });
    return data;
  }, []);
